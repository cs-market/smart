...
namespace Tygh\Addons\SberbankMobilePayment\Payments;
...
use Tygh\Payments\Processors\Sberbank as SberbankCore;
use Tygh\Tools\Url;

class Sberbank implements IRedirectionPayment
{
