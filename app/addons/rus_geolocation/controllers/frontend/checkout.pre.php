...
$city_geolocation = null;
if (isset(Tygh::$app['session']['customer_loc']['city'])) {
    Tygh::$app['session']['geocity'] = Tygh::$app['session']['customer_loc']['city'];
}
if (isset(Tygh::$app['session']['geocity'])){
