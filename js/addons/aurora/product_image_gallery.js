    ...
    load: function load(container, params) {
      if (scroller_type == 'owlcarousel') {
        ...
        if (params.is_pagination) {
            owl_params.pagination = true;
            owl_params.navigation = false;
            owl_params.navigationText = ['', ''];
            owl_params.paginationSpeed = params.pagination_speed || 0;
        } else {
            owl_params.pagination = false;
            owl_params.navigation = true;
            owl_params.navigationText = params.items_count == 1 ? ['<i class="icon-left-circle ty-icon-left-circle"></i>', '<i class="icon-right-circle ty-icon-right-circle"></i>'] : ['<i class="icon-left-open-thin ty-icon-left-open-thin"></i>', '<i class="icon-right-open-thin ty-icon-right-open-thin"></i>'];
            owl_params.theme = params.items_count == 1 ? 'owl-one-theme' : 'owl-more-theme';
        }

        container.owlCarousel(owl_params);
        // [changed]
      } else {
        $('li', container).show();
        container.jcarousel({
