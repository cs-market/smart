...
<a id="sw_elm_pagination_steps" class="ty-sort-dropdown__wrapper cm-combination">{__(show)}: {$pagination.items_per_page} {__("per_page")}<i class="ty-sort-dropdown__icon ty-icon-down-micro"></i></a>
