<div class="ty-quick-view-button">
    ...
    {/if}
    <a class="ty-btn ty-btn__text cm-dialog-opener cm-dialog-auto-size cm-tooltip" title="{__("quick_view")}" data-ca-view-id="{$product.product_id}" data-ca-target-id="product_quick_view" href="{$quick_view_url|fn_url}" data-ca-dialog-title="{__("quick_product_viewer")}" rel="nofollow"><i class="ty-azure-icon-quick-view"></i></a>
</div>