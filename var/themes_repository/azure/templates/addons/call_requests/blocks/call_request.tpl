...
<div class="ty-cr-phone-number-link">
    <i class="ty-azure-icon-phone"></i>
    <div class="ty-cr-phone">
        <div class="ty-cr-work">{__("call_request.work_time")}</div>
        <div><bdi><span class="ty-cr-phone-prefix">{$phone_number.prefix}</span>{$phone_number.postfix}</bdi></div>
