    ...
    <div class="ty-blog-recent-posts-scroller">
        ...
        {foreach from=$items item="page"}
            <div class="ty-blog-recent-posts-scroller__item">
                ...
                <div class="ty-blog-recent-posts-scroller__item-name"><a href="{"pages.view?page_id=`$page.page_id`"|fn_url}">{$page.page}</a></div>
                <div class="ty-blog-recent-posts-scroller__spoiler">
                    <div class="ty-wysiwyg-content">
                        <div>{$page.spoiler|strip_tags|truncate:80 nofilter}</div>
                    </div>
                </div>
