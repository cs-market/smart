{hook name="profiles:account_info"}
    ...
    <div class="ty-control-group">
        <label for="email" class="ty-control-group__title cm-trim">{__("login")}</label>
        <input type="text" id="email" name="user_data[user_login]" size="32" maxlength="128" value="{$user_data.user_login}" class="ty-input-text cm-focus" />
    </div>
