...
<script type="text/javascript" class="cm-ajax-force">
    (function(_, $) {
        var event_name = 'ce.commoninit';

        {if $runtime.controller == 'checkout' && $runtime.mode == 'add'}
            event_name = 'ce.ajaxdone';
        {/if}

        $.ceEvent('on', event_name, function(context) {
            var elm = $(document).find('#scroll_list_{$block.block_id}');
