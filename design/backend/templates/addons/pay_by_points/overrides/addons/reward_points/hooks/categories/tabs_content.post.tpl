    ...
    <div id="reward_points_categories_hook" class="in collapse">
        <fieldset>
            <div class="control-group">
                <label class="control-label" for="cd_earned_points_eq_price">{__("pay_by_points__earned_points_eq_price")}</label>
                <div class="controls">
                    <input type="hidden" name="category_data[earned_points_eq_price]" value="N" />
                    <input type="checkbox" name="category_data[earned_points_eq_price]" id="cd_earned_points_eq_price" value="Y" {if $category_data.earned_points_eq_price == "Y"}checked="checked"{/if}>
                </div>
            </div>
