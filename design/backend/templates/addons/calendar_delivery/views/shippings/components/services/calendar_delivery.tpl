...
<div class="control-group">
    ...
    <div class="controls">
        ...
        <input id="elm_offer_documents" type="checkbox" name="shipping_data[service_params][depends_on_parent]" value="Y" {if $shipping.service_params.depends_on_parent == "YesNo::YES"|enum}checked="_checked"{/if} onclick="Tygh.$.disable_elms(['shipping_nearest_delivery_today', 'shipping_nearest_delivery_tomorrow', 'shipping_nearest_delivery_aftertomorrow', 'shipping_nearest_delivery_other', 'shipping_nearest_delivery_other_input', 'elm_company_working_time_till', 'elm_company_saturday_shipping', 'elm_company_sunday_shipping', 'elm_company_monday_rule', 'elm_company_period_start', 'elm_company_period_finish', 'elm_company_period_step'], this.checked);">
    </div>
</div>

{include file="addons/calendar_delivery/components/nearest_delivery.tpl" disabled=$shipping.service_params.depends_on_parent=="YesNo::YES"|enum id='shipping_nearest_delivery' name='shipping_data[service_params][nearest_delivery]' params=$shipping.service_params}
...
<div class="control-group">
    ...
    <div class="controls">
        <input class="input-mini cm-trim" id="elm_company_working_time_till" size="5" maxlength="5" type="text" name="shipping_data[service_params][working_time_till]" value="{$shipping.service_params.working_time_till}" placeholder="00:00" {if $shipping.service_params.depends_on_parent == "YesNo::YES"|enum}disabled="_disabled"{/if}/>
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input class="input-mini cm-trim" id="elm_company_period_start" size="5" maxlength="5" type="text" name="shipping_data[service_params][period_start]" value="{$shipping.service_params.period_start}" placeholder="00:00" {if $shipping.service_params.depends_on_parent == "YesNo::YES"|enum}disabled="_disabled"{/if}/>
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input class="input-mini cm-trim" id="elm_company_period_finish" size="5" maxlength="5" type="text" name="shipping_data[service_params][period_finish]" value="{$shipping.service_params.period_finish}" placeholder="00:00" {if $shipping.service_params.depends_on_parent == "YesNo::YES"|enum}disabled="_disabled"{/if}/>
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input class="input-micro cm-trim" id="elm_company_period_step" size="2" maxlength="2" type="text" name="shipping_data[service_params][period_step]" value="{$shipping.service_params.period_step}" placeholder="2" {if $shipping.service_params.depends_on_parent == "YesNo::YES"|enum}disabled="_disabled"{/if}/>
    </div>
</div>
