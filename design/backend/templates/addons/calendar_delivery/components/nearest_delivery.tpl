<div class="control-group">
    ...
    <div class="controls">
        ...
        <label class="radio inline" for="{$id}_aftertomorrow" onclick="Tygh.$('#{$id}_other_wrapper').switchAvailability(true, false);"><input type="radio" name="{$name}" id="{$id}_aftertomorrow" {if $params.nearest_delivery == '2'}checked="checked"{/if} value="2" {if $disabled}disabled="_disabled"{/if}>{__('after_tomorrow')}</label>
