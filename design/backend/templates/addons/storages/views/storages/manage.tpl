...
{include file="common/mainbox.tpl" title=__("storages") content=$smarty.capture.mainbox adv_buttons=$smarty.capture.adv_buttons buttons=$smarty.capture.buttons content_id="manage_users" select_languages=true}
