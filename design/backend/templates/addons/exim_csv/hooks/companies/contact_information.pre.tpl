...
<div class="control-group">
	<label class="control-label" for="elm_company_autoload_csv">{__("autoload_csv")}:</label>
	<div class="controls">
		<input type="hidden" name="company_data[autoload_csv]" value="N" />
		<input type="checkbox" name="company_data[autoload_csv]" id="elm_company_export_order_to_csv" value="Y" {if $company_data.autoload_csv == 'Y'} checked="checked"{/if} />
	</div>
</div>