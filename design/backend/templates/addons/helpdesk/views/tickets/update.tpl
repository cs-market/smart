...
<form action="{""|fn_url}"  enctype="multipart/form-data" method="post" name="ticket_form" class="form-horizontal form-edit  cm-disable-empty-files  cm-processed-form cm-check-changes{*if ""|fn_check_form_permissions} cm-hide-inputs{/if*}">
