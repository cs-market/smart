...
{if $view_mode == "single_button"}
    ...
    <div class="input-append ty-relative">
        <a href="{"profiles.update?user_id=`$item_ids`"|fn_url}" target="_blank" class="picker-user-external-link"><i class="icon-external-link"></i></a>
