...
<p>
    <span>{$product.amount}</span><span>&nbsp;x&nbsp;</span>{if $product.extra.pay_by_points.use_bonus_pay}{__("points_lowercase", [$product.extra.pay_by_points.product_cart_point_price/$product.amount])}{else}{include file="common/price.tpl" value=$product.display_price span_id="price_`$key`_`$dropdown_id`" class="none"}{/if}
</p>
</div>
