{if $storages}
    <div class="ty-dropdown-box">
        <div id="sw_elm_dropdown_storages_{$block.snapping_id}" class="ty-dropdown-box__title cm-combination">
            <a>
        ...
        <ul id="elm_dropdown_storages_{$block.snapping_id}" class="ty-dropdown-box__content cm-popup-box hidden">
