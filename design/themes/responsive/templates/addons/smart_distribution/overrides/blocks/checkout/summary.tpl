            ...
            <tr>
                <th class="ty-checkout-summary__total" colspan="2" data-ct-checkout-summary="order-total">
                    ...
                    <div class="total-weight">
                        {__("products_weight")}
                        <span class="ty-checkout-summary__total-weight ty-float-right">{$cart.product_groups.0.package_info_full.packages.0.weight} ({$settings.General.weight_symbol nofilter})</span>
                    </div>
                </th>
            </tr>
        </tbody>
